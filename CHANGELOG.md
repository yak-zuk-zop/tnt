...
- user socket options
- enforced a strict execution time limit for every request

### Fixed

- capped `gen_tcp:recv` request size to prevent `enomem` on large payloads

## [1.0.3] - 2026-08-03

### Changed

- replaced pseudo-synchronous call (async + manual receive) with native OTP `gen_statem:call` for proper synchronous request handling
- removed extra record `tnt_error`
- moved protocol specific routines from `tnt_worker` module to `tnt_proto`
...
[1.0.4]: https://github.com/yak-zuk-zop/tnt/compare/v1.0.3...v1.0.4
[1.0.3]: https://github.com/yak-zuk-zop/tnt/compare/v1.0.2...v1.0.3
